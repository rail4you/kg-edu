...
export default function ManualPage() {
  ...
  const { data: manualsData, isLoading, error } = useQuery({
    queryKey: ["manual-templates", currentTenant?.id],
    queryFn: () =>
      listFileTemplates({
        tenant: currentTenant?.schemaName || "",
        fields: ["id", "section", "filePath"],
        filter: { section: "student_manual" },
        sort: "-id",
        ...
        <div style={{
          ...
          <div style={{ padding: "36px 40px 28px", borderBottom: "1px solid #f0f0f0" }}>
            ...
            <Text style={{ fontSize: 15, lineHeight: 2, color: "#595959", display: "block" }}>
              ...
              你可以在下方下载完整的使用手册文档，也可以在线预览。建议先下载到本地，方便随时查阅。
            </Text>
          </div>
          ...
          {manuals.length === 0 ? (
            <div style={{ padding: "60px 40px", textAlign: "center" }}>
              ...
              <Title level={4} style={{ color: "#999", fontWeight: 400 }}>暂无可用的学生使用手册</Title>
        ...
        <div style={{ display: "flex", gap: 20, marginTop: 20 }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <QuestionCircleOutlined style={{ color: "#2573E6", fontSize: 16 }} />
              ...
              {helpItems.map((item, idx) => (
                ...
                >
                  <div style={{
                    ...
                    alignItems: "center", justifyContent: "center",
                    flexShrink: 0, color: "#2573E6", fontSize: 15,
                  }}>
                    {item.icon}
                  </div>
                  <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
              <ReadOutlined style={{ color: "#2573E6", fontSize: 15 }} />
              <Text strong style={{ fontSize: 14, color: "#2573E6" }}>温馨提示</Text>
            </div>
            <Text style={{ fontSize: 13, color: "#4d8fef", lineHeight: 1.8 }}>
              建议先下载手册到本地，方便随时查阅。如遇到学习问题，可先查看手册中的常见问题，或直接联系老师获取帮助。
            </Text>
          </div>
        </div>
      </div>
