...
export function TeacherForm({ user, onSubmit, onCancel, loading }: TeacherFormProps) {
      ...
      <Row gutter={24}>
        ...
        <Col span={12}>
          <Form.Item name="employeeId" label="工号">
            <Input prefix={<IdcardOutlined />} placeholder="可选，教师的工号" />
          </Form.Item>
        </Col>
        ...
        <Col span={24}>
          ...
          >
            ...
            <div style={{ marginTop: 8 }}>
              ...
              {isSuperAdmin ? (
                <Typography.Text type="secondary" style={{ fontSize: 12 }}>
                  不设置期限表示不限时间；超出设置期限后教师仅可查看，无法进行任何编辑操作。
                </Typography.Text>
              ) : (
                <Typography.Text type="secondary" style={{ fontSize: 12 }}>
