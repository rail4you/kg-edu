defmodule KgEdu.Chat.Message do
  use Ash.Resource,
    otp_app: :kg_edu,
    domain: KgEdu.Chat,
    extensions: [AshOban],
  ...
  oban do
    triggers do
      trigger :respond do
        actor_persister KgEdu.AiAgentActorPersister
        action :respond
        queue :chat_responses
        lock_for_update? false
        scheduler_cron false
        worker_module_name KgEdu.Chat.Message.Workers.Respond
        scheduler_module_name KgEdu.Chat.Message.Schedulers.Respond
  ...
  actions do
    ...
    create :create do
      ...
      change KgEdu.Chat.Message.Changes.CreateConversationIfNotProvided
    ...
    update :respond do
      ...
      transaction? false
      change KgEdu.Chat.Message.Changes.Respond
    end
  ...
  attributes do
    ...
    attribute :source, KgEdu.Chat.Message.Types.Source do
      allow_nil? false
      public? true
      default :user
    end
  ...
  relationships do
    belongs_to :conversation, KgEdu.Chat.Conversation do
      public? true
      allow_nil? false
    end
